...
<%	'**************************************************************************
  ...
  smtpServer = "12.161.178.216"       'pointing to external mail.dlsg.com (TR-2016.04.27)
	...
	allowedHosts      = Array("dlsg.com", "www.dlsg.com", "dlsg.net", "www.dlsg.net", "hybridlibraries.com", "www.hybridlibraries.com", "imageaccess.com", "www.imageaccess.com")
	allowedRecipients = Array("DemoRequest@DLSG.net", "contactus@dlsg.net", "orders@dlsg.net", "support@dlsg.net", "DemoRequest@DLSG.com", "contactus@dlsg.com", "orders@dlsg.com", "support@dlsg.com")
