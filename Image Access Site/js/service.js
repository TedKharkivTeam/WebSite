$(function () {
    ...
    map.on('zoomend', function (e) {
        ...
        if (e.target._zoom < currentZoom && e.target._zoom <= 2) {
    ...
    var US_CAN_LayerGroup = L.featureGroup().addTo(map).on('click', function (e) {
        map.fitBounds(US_CAN_LayerGroup.getBounds(), {maxZoom: 7});
    });
    L.geoJson(mapAreas.US_CAN.geoJson, {
        onEachFeature: function (feature, layer) {
            // TODO: Replace color in setStyle option.
            US_CAN_LayerGroup.addLayer(L.GeoJSON.geometryToLayer(feature).setStyle({
                fillColor: 'red',
                weight: 1,
                opacity: 0.5,
                color: 'white',
    ...
    var CARIBBEAN_LayerGroup = L.featureGroup().addTo(map).on('click', function (e) {
        map.fitBounds(CARIBBEAN_LayerGroup.getBounds(), {maxZoom: 7});
    });
    L.geoJson(mapAreas.CARIBBEAN.geoJson, {
        onEachFeature: function (feature, layer) {
            // TODO: Replace color in setStyle option.
    ...
    var CENTRALAMERICA_LayerGroup = L.layerGroup().addTo(map).on('click', function (e) {
        map.fitBounds(CENTRALAMERICA_LayerGroup.getBounds(), {maxZoom: 7});
    });
    L.geoJson(mapAreas.CENTRALAMERICA.geoJson, {
        onEachFeature: function (feature, layer) {
            // TODO: Replace color in setStyle option.
    ...
    var CUBA_LayerGroup = L.featureGroup().addTo(map).on('click', function (e) {
        map.fitBounds(CUBA_LayerGroup.getBounds(), {maxZoom: 7});
    });
    L.geoJson(mapAreas.CUBA.geoJson, {
        onEachFeature: function (feature, layer) {
            // TODO: Replace color in setStyle option.
            CUBA_LayerGroup.addLayer(L.GeoJSON.geometryToLayer(feature).setStyle({
                fillColor: 'red',
                weight: 1,
                opacity: 0.5,
                color: 'white',
    ...
    var MEXICO_LayerGroup = L.featureGroup().addTo(map).on('click', function (e) {
        map.fitBounds(MEXICO_LayerGroup.getBounds(), {maxZoom: 7});
    });
    L.geoJson(mapAreas.MEXICO.geoJson, {
        onEachFeature: function (feature, layer) {
            // TODO: Replace color in setStyle option.
            MEXICO_LayerGroup.addLayer(L.GeoJSON.geometryToLayer(feature).setStyle({
                fillColor: 'red',
                weight: 1,
                opacity: 0.5,
                color: 'white',
    ...
    var BOLIVIA_LayerGroup = L.featureGroup().addTo(map).on('click', function (e) {
        map.fitBounds(BOLIVIA_LayerGroup.getBounds(), {maxZoom: 7});
    });
    L.geoJson(mapAreas.BOLIVIA.geoJson, {
        onEachFeature: function (feature, layer) {
            // TODO: Replace color in setStyle option.
            BOLIVIA_LayerGroup.addLayer(L.GeoJSON.geometryToLayer(feature).setStyle({
                fillColor: 'red',
                weight: 1,
                opacity: 0.5,
                color: 'white',
    ...
    var SOUTHAMERICA_LayerGroup = L.featureGroup().addTo(map).on('click', function (e) {
        map.fitBounds(SOUTHAMERICA_LayerGroup.getBounds(), {maxZoom: 7});
    });
    L.geoJson(mapAreas.SOUTHAMERICA.geoJson, {
        onEachFeature: function (feature, layer) {
            // TODO: Replace color in setStyle option.
    ...
    var AUSTRALIA_NZ_LayerGroup = L.featureGroup().addTo(map).on('click', function (e) {
        map.fitBounds(AUSTRALIA_NZ_LayerGroup.getBounds(), {maxZoom: 7});
    });
    L.geoJson(mapAreas.AUSTRALIA_NZ.geoJson, {
        onEachFeature: function (feature, layer) {
            // TODO: Replace color in setStyle option.
            AUSTRALIA_NZ_LayerGroup.addLayer(L.GeoJSON.geometryToLayer(feature).setStyle({
                fillColor: 'red',
                weight: 1,
                opacity: 0.5,
                color: 'white',
    ...
    var EUROPE = L.featureGroup().addTo(map).on('click', function (e) {
        map.fitBounds(EUROPE.getBounds(), {maxZoom: 7});
    });
    L.geoJson(mapAreas.EUROPE.geoJson, {
        onEachFeature: function (feature, layer) {
            // TODO: Replace color in setStyle option.
            EUROPE.addLayer(L.GeoJSON.geometryToLayer(feature).setStyle({
                fillColor: 'red',
                weight: 1,
                opacity: 0.5,
                color: 'white',
    ...
    var ASIA = L.featureGroup().addTo(map).on('click', function (e) {
        map.fitBounds(ASIA.getBounds(), {maxZoom: 7});
    });
    L.geoJson(mapAreas.ASIA.geoJson, {
        onEachFeature: function (feature, layer) {
            // TODO: Replace color in setStyle option.
            ASIA.addLayer(L.GeoJSON.geometryToLayer(feature).setStyle({
                fillColor: 'red',
                weight: 1,
                opacity: 0.5,
                color: 'white',
    ...
    var AFRICA = L.featureGroup().addTo(map).on('click', function (e) {
        map.fitBounds(AFRICA.getBounds(), {maxZoom: 7});
    });
    L.geoJson(mapAreas.AFRICA.geoJson, {
        onEachFeature: function (feature, layer) {
            // TODO: Replace color in setStyle option.
            AFRICA.addLayer(L.GeoJSON.geometryToLayer(feature).setStyle({
                fillColor: 'red',
                weight: 1,
                opacity: 0.5,
                color: 'white',
    ...
    var MIDDLEEAST = L.featureGroup().addTo(map).on('click', function (e) {
        map.fitBounds(MIDDLEEAST.getBounds(), {maxZoom: 7});
    });
    L.geoJson(mapAreas.MIDDLEEAST.geoJson, {
        onEachFeature: function (feature, layer) {
            // TODO: Replace color in setStyle option.
            MIDDLEEAST.addLayer(L.GeoJSON.geometryToLayer(feature).setStyle({
                fillColor: 'red',
                weight: 1,
                opacity: 0.5,
                color: 'white',
    ...
    var RESTOFTHEWORLD_LayerGroup = L.featureGroup().addTo(map).on('click', function (e) {
        map.fitBounds(RESTOFTHEWORLD_LayerGroup.getBounds(), {maxZoom: 7});
    });
    L.geoJson(mapAreas.RESTOFTHEWORLD.geoJson, {
        onEachFeature: function (feature, layer) {
            // TODO: Replace color in setStyle option.
